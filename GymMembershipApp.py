...
print('-' * 50)
print('Live Fit Gym '.center(50, '-'))
print('-' * 50)

while True:
    print("For Login as Member Enter 1 and For SuperUser Enter 2:")
    print("To Exit Enter 0")
    who = int(input())

    if who == 1:
        print('Member'.center(50, "-"))
        while True:
            print('''
                    1=> My Regimen
                    2=> My Profile
            ...
            if choice == 1:
                ...
                print("Regimen Based on your BMI".center(50,"-"))
